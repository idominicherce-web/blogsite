 ...
 * * Compiles known database posts during run-time checks.
 * ============================================================================
 */
...
export default async function BlogPostPage({
	...
	return (
		<>
			...
			<PostWrapper>
				{/* 🚀 Wrap the main dynamic render container to trigger your custom post skeleton  */}
				<Suspense fallback={<BlogPostLoading />}>
					<DeferredPostContent slug={slug} admin={admin} />
				</Suspense>
			</PostWrapper>
		</>
	);

...
export default function BlogWrapper({
	...
	return (
		<div className="min-h-screen bg-[#1a120d] text-zinc-100 font-serif relative overflow-x-hidden selection:bg-amber-300 selection:text-amber-950 group/tavern">
			...
			{/* 🪵 MOBILE-FIRST SHADOW FLOOR: Dynamic scale setup */}
			<div className="absolute bottom-0 inset-x-0 h-24 md:h-40 bg-linear-to-b from-[#18100a] to-[#0d0805] border-t-8 border-[#21160e] pointer-events-none z-0">
				<div className="absolute inset-0 opacity-20 bg-[linear-gradient(to_bottom,transparent_95%,#000_95%),linear-gradient(to_right,transparent_98%,#2a1b13_98%)] bg-size-[240px_100%]" />
			</div>

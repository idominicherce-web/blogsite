...
export default function PostWrapper({
	...
	return (
		<div className="relative min-h-dvh overflow-x-hidden bg-[#1a120d] font-serif text-zinc-100 antialiased selection:bg-amber-300 selection:text-amber-950 group/tavern">
			{/* Vignette */}
			...
			{/* Top Boundary Accent */}
			<div className="pointer-events-none absolute top-0 inset-x-0 h-10 bg-linear-to-b from-[#2a1b13] to-[#1a120d] border-b-4 border-[#3a2418] shadow-xl z-30 opacity-95">
			...
			{/* Lanterns */}
			<div className="absolute left-[8%] top-10 z-20 hidden h-32 w-px bg-zinc-700/50 md:block">
			...
			<div className="absolute right-[8%] top-10 z-20 hidden h-40 w-px bg-zinc-700/50 md:block">
			...
			{/* Embers - Set to z-0 so they float behind content */}
